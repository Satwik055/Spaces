...
import com.satwik.spaces.features.details.presentation.detail_screen.components.BottomBarSection
import com.satwik.spaces.features.details.presentation.detail_screen.components.ImageSlider
import com.satwik.spaces.features.details.presentation.detail_screen.components.PropertyInfoSection
    ...
    Box(
        ...
        Column(
            ...
            Row (
                ...
                AmenitiesChip(name = "${property.floor} Floor", icon = R.drawable.ic_building)
                AmenitiesChip(name = "${property.carpetArea} sqft", icon = R.drawable.ic_area)
                AmenitiesChip(name = "${property.people} People", icon = R.drawable.ic_people)
            }
            Spacer(modifier = Modifier.height(30.dp))
