...
import com.satwik.spaces.details.presentation.detail_screen.components.BottomBarSection
import com.satwik.spaces.details.presentation.detail_screen.components.ImageSlider
import com.satwik.spaces.details.presentation.detail_screen.components.PropertyInfoSection
...
//                    Counter(viewModel = viewModel)
            ...
            BottomBarSection(
                ...
                onClick = { navController.navigate(Screen.Checkout.passId(it.id)) }
            )
        }
    }
}
